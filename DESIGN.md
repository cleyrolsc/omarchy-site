...
status: active
name: Omarchy
source: barisgirismen/omarchy-site@a91c42895cc5fe29dc3e92955d547d419e9c1ff2
...
Core content, links, headings, download buttons and media posters must work without JavaScript. Browser modules enhance theme selection, search, navigation, media playback, gallery dialogs, and the existing canvas/audio engine. Respect reduced motion; do not autoplay audible music or fetch third-party video players before interaction. Keep controls keyboard accessible and label every dialog and form field.
