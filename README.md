...
The 2026-09-07 follow-up audit confirmed that `221b61b` remains the upstream head. It restored the hero's effect replay and initial reveal, removed the extra right-click theme shortcut, matched the optional effect panel's spacing and the 300ms desktop theme-preview fade, and restored the wordmark preload and social-image metadata. Browser coverage observes real ttfx sessions for mouse/touch replay, explicit effects, reduced motion, theme changes, Astro navigation, module-loading failure, and the 404 home action. The effect, music, theme, search, and outbound-link engines were compared with the pinned source; content/assets and desktop/mobile layout checks remain in place. The install-link colors requested separately remain a documented design choice.
