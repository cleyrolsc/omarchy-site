...
{
  "title": "Omarchy CLI",
  "description": "Omarchy is usually controlled through the hotkeys and the Omarchy menu ( Super + Space ). But you can also control it through the omarchy CLI. This is particula",
  "order": 13,
  "path": "/manual/omarchy-cli/",
  "format": "html"
}
---

<p>Omarchy is usually controlled through the hotkeys and the Omarchy menu (<code>Super + Space</code>). But you can also control it through the <code>omarchy</code> CLI. This is particularly helpful when you’re having an AI agent work with you on customization or configuration.</p>

<p>The CLI has access to all the internal tooling that is used both via the menu and otherwise. You can see everything that’s available by running <code>omarchy</code> in the terminal.</p>
...
<p>And you can dive deeper on every group:</p>
...
<h3 id="opening-the-menu-from-the-terminal"><a class="manual__heading-link" href="#opening-the-menu-from-the-terminal" aria-label="Link to this section">Opening the menu from the terminal<span class="manual__hash" aria-hidden="true">#</span></a></h3>
