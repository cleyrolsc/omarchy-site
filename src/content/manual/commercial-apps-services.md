---
{
  ...
  "description": "Omarchy is mostly focused on providing free, open source software, but it’s not religious about it. Sometimes the best solution is a commercial offering, and th",
  "order": 23,
  "path": "/manual/commercial-apps-services/",
  "format": "html"
}
---
...
<h2 id="1password"><a class="manual__heading-link" href="#1password" aria-label="Link to this section">1Password<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="bitwarden"><a class="manual__heading-link" href="#bitwarden" aria-label="Link to this section">Bitwarden<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="spotify"><a class="manual__heading-link" href="#spotify" aria-label="Link to this section">Spotify<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="dropbox"><a class="manual__heading-link" href="#dropbox" aria-label="Link to this section">Dropbox<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<p>It gets a panel in the bar, a web app for the admin console, and Taildrop for sending files between your machines - see <a href="/manual/networking/">networking</a>.</p>

<h2 id="once"><a class="manual__heading-link" href="#once" aria-label="Link to this section">ONCE<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="nordvpn"><a class="manual__heading-link" href="#nordvpn" aria-label="Link to this section">NordVPN<span class="manual__hash" aria-hidden="true">#</span></a></h2>
