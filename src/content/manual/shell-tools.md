...
{
  "title": "Shell Tools",
  "description": "In addition to the standard Linux tools, Omarchy also ships with a bunch of enhanced shell tools. Here are the key ones. fzf fzf gives you fuzzy finding of file",
  "order": 18,
  "path": "/manual/shell-tools/",
  "format": "html"
}
---
...
<h2 id="fzf"><a class="manual__heading-link" href="#fzf" aria-label="Link to this section">fzf<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<p>You can use <code>Ctrl + R</code> to use fzf to fuzzy find through your command history.</p>

<p>This tool is also used by Neovim when you type <code>Space Space</code>.</p>

<p>The full manual can be found via <code>man fzf</code>.</p>

<h2 id="zoxide"><a class="manual__heading-link" href="#zoxide" aria-label="Link to this section">Zoxide<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="ripgrep"><a class="manual__heading-link" href="#ripgrep" aria-label="Link to this section">ripgrep<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<p>This tool is also used by Neovim when you type <code>Space S G</code>.</p>

<p>The full manual can be found via <code>man rg</code>.</p>

<h2 id="eza"><a class="manual__heading-link" href="#eza" aria-label="Link to this section">eza<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="fd"><a class="manual__heading-link" href="#fd" aria-label="Link to this section">fd<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="bat"><a class="manual__heading-link" href="#bat" aria-label="Link to this section">bat<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="tldr"><a class="manual__heading-link" href="#tldr" aria-label="Link to this section">tldr<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="yt-dlp"><a class="manual__heading-link" href="#yt-dlp" aria-label="Link to this section">yt-dlp<span class="manual__hash" aria-hidden="true">#</span></a></h2>
...
<h2 id="try"><a class="manual__heading-link" href="#try" aria-label="Link to this section">try<span class="manual__hash" aria-hidden="true">#</span></a></h2>
