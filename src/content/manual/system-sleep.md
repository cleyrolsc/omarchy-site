...
{
  "title": "System sleep",
  "description": "Omarchy enables suspend and hibernation by default, but if you’re having issues with either on your machine, you can toggle them off. Power profiles On a laptop",
  "order": 35,
  "path": "/manual/system-sleep/",
  "format": "html"
}
---
...
<h3 id="power-profiles"><a class="manual__heading-link" href="#power-profiles" aria-label="Link to this section">Power profiles<span class="manual__hash" aria-hidden="true">#</span></a></h3>
...
<h3 id="toggle-suspend"><a class="manual__heading-link" href="#toggle-suspend" aria-label="Link to this section">Toggle suspend<span class="manual__hash" aria-hidden="true">#</span></a></h3>
...
<h3 id="toggle-hibernation"><a class="manual__heading-link" href="#toggle-hibernation" aria-label="Link to this section">Toggle hibernation<span class="manual__hash" aria-hidden="true">#</span></a></h3>
...
<p>When set up, you’ll see the hibernate option under <em>System</em> (or <code>Super + Esc</code>), and then you can see if it works consistently on your system. If not, you can remove it again by running <code>omarchy hibernation remove</code>.</p>
